   ...
   data[, (cols_existentes) := lapply(.SD, as.character), .SDcols = cols_existentes]
    ...
    data <- dtplyr::lazy_dt(data)
      ...
      if ("PA_TPUPS" %in% variables_names) {
        #Labels retirados de:
        #https://rnds-fhir.saude.gov.br/CodeSystem-BRTipoEstabelecimentoSaude.html
        data <- data %>% dplyr::mutate(
        def_PA_TPUPS = dplyr::case_match(.data$PA_TPUPS,
          "84" ~ "CENTRAL DE ABASTECIMENTO",    
          "82" ~ "CENTRAL DE NOTIFICAÇÃO,CAPTAÇÃO E DISTRIB DE ORGÂOS ESTADUAL",
          "74" ~ "POLO ACADEMIA DA SAÚDE",
          "83" ~ "POLO DE PREVENÇÃO DE DOENÇAS E AGRAVOS E PROMOÇÃO DA SAÚDE",
          "81" ~ "CENTRAL DE REGULAÇÂO DO ACESSO",
          ...
          "02" ~ "CENTRO DE SAÚDE/UNIDADE BASÍCA DE SAÚDE",
          "64" ~ "CENTRAL DE REGULAÇÃO DE SERVICOS DE SAÚDE",
          "36" ~ "CLÍNICA ESPECIALIZADA/AMBULATÓRIO ESPECIALIZADO",
          "22" ~ "CONSULTÓRIO ISOLADO", 
          "60" ~ "COOPERATIVA OU EMPRESA DE CESSÂO DE TRABALHADORES NA SAÚDE",
          "43" ~ "FARMÁCIA", 
          ...
          "39" ~ "UNIDADE DE SERVICO DE APOIO DE DIAGNOSE E TERAPIA (SADT ISOLADO)",
          ...
          "15" ~ "UNIDADE MISTA", 
          "42" ~ "UNIDADE MÓVEL DE NÍVEL PRÉ-HOSP-URGÊNCIA/EMERGÊNCIA",
